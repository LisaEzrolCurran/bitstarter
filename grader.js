...
var URL_DEFAULT = "http://warm-crag-6776.herokuapp.com/";
...
/*
var cheerioURL = function(urlToCheck, checksfile) {
    console.log("cheerio URL: "+urlToCheck+ "\n");

    rest.get(urlToCheck).on('complete',function(result, response) {
...
if(require.main == module) {
	...
	.option('-u, --url <url>', 'url to check', assertURLExists)
	...
	.parse(process.argv);
	 ...
	 var checkJsonURL = checkURL(program.url, program.checks);
	    ...
	    var outJson = JSON.stringify(checkJsonFile, null, 4);
	    console.log(outJson);
	}
